...
Here, $l = m = n = k$, so
\[
k^2 + k^2 + k^2 = 1 \implies 3k^2 = 1 \implies k^2 = \frac{1}{3}
\]
...
Hence, the line vectors are:
\[
\vec{v}_1 = \left(\frac{1}{\sqrt{3}}, \frac{1}{\sqrt{3}}, \frac{1}{\sqrt{3}}\right), \quad
\vec{v}_2 = \left(-\frac{1}{\sqrt{3}}, -\frac{1}{\sqrt{3}}, -\frac{1}{\sqrt{3}}\right)
\]
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\columnwidth]{beamer/figs/Figure_1.png} 
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\columnwidth]{beamer/figs/Figure_2.png} 
