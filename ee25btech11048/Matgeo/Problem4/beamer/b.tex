...
\begin{frame}{Equilateral and Scalene Triangle check}
    \begin{align}
AB^2 &= (\vec{B}-\vec{A})^\top (\vec{B}-\vec{A}) = \myvec{8&0}\myvec{8\\0} = 64 \\
BC^2 &= (\vec{C}-\vec{B})^\top (\vec{C}-\vec{B}) = \myvec{-4&3}\myvec{-4\\3} = 16 + 9 = 25 \\
AC^2 &= (\vec{C}-\vec{A})^\top (\vec{C}-\vec{A}) = \myvec{4&3}\myvec{4\\3} = 16 + 9 = 25
\end{align}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\columnwidth]{beamer/figs/Figure_1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\columnwidth]{beamer/figs/Figure_2.png}
